...
public sealed record UpdateSellerPoliciesRequest(string WarrantyPolicy, string ShippingPolicy, string ReturnPolicy);
...
public interface ICatalogService
{
    ...
    Task<SellerDto?> GetSellerByIdAsync(Guid sellerId, CancellationToken cancellationToken = default);
    ...
    Task<SellerDto> UpdateSellerPoliciesAsync(Guid userId, UpdateSellerPoliciesRequest request, CancellationToken cancellationToken = default);
